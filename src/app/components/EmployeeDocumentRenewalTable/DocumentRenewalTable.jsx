...
// Importing default export 'makeData' instead of named export 'data'
    ...
    <div className={`card`}>
      <div className='card-header border-0 pt-5 pb-2'>
        <h3 className='card-title align-items-start flex-column'>
          ...
          <span className='text-muted mt-1 fw-semibold fs-7'>[{makeData.length} entries]</span>
        </h3>
      ...
      <div className='card-body'>
        <MaterialReactTable
          columns={columns}
          data={makeData} // Use 'makeData' instead of 'data'
